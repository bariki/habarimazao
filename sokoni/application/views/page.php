...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        <div id="head"> <div class="cols"><div class="large-12"><a class="men1" href="<?php echo base_url(); ?>">
          <img src="<?php echo base_url(); ?>theme/images/logo.png"></a>
          <a id="sticky_box" href="<?php echo base_url('msaada'); ?>"  class="men">Msaada</a>
        ...
        <div id="content" >
            <ul class="breadcrumbs">
              ...
              ?>
              <li class="menu" style="float:right"><a id="lang" href="#" class="menu" >LANGUAGE</a></li>
